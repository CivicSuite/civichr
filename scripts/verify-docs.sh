...
stale_patterns=(CivicData civicdata CivicComms civiccomms Civic311 civic311 "live CKAN" "data warehouse" "0.1.1.dev0" "~=0.2" "MIT")
...
if ! grep -Fq "civiccore==0.3.0" README.md; then echo "VERIFY-DOCS: FAILED README.md must mention civiccore==0.3.0"; exit 1; fi
